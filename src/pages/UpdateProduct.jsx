        ...
        <form onSubmit={handleSubmit} className="p-2">
          <div className="mb-3">
            ...
            <input
              ...
              value={yeniVeri.name}
              onChange={(e) =>
                setYeniVeri({ ...yeniVeri, name: e.target.value })
              }
              required
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              required
              onChange={(e) =>
                setYeniVeri({ ...yeniVeri, price: e.target.value })
              }
            />
          </div>
          <div className="mb-3">
            ...
            <input
              ...
              required
              onChange={(e) =>
                setYeniVeri({ ...yeniVeri, amount: e.target.value })
              }
            />
          </div>
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              required
              onChange={(e) =>
                setYeniVeri({ ...yeniVeri, image: e.target.value })
              }
            />
          </div>
